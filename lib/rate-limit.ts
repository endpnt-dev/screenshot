  ...
  if (!rateLimiters) {
    ...
    rateLimiters = {
      free: new Ratelimit({
        ...
        analytics: true,
        prefix: 'endpnt:ratelimit:screenshot:free',
      }),
      starter: new Ratelimit({
        ...
        analytics: true,
        prefix: 'endpnt:ratelimit:screenshot:starter',
      }),
      pro: new Ratelimit({
        redis: redisInstance,
        limiter: Ratelimit.slidingWindow(
        ...
        analytics: true,
        prefix: 'endpnt:ratelimit:screenshot:pro',
      }),
      enterprise: new Ratelimit({
        ...
        analytics: true,
        prefix: 'endpnt:ratelimit:screenshot:enterprise',
      }),
    }
  }
  return rateLimiters
...
function initializeDemoRateLimiter() {
  if (!demoRateLimiter) {
    ...
    demoRateLimiter = new Ratelimit({
      ...
      analytics: true,
      prefix: 'endpnt:demo:screenshot:ratelimit',
    })
  }
